...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Jun-2023 às 05:28
...
(5, '2015-12-31', 6, 1, 1, 'Roberta Silva', '12:00:00');
...
--
ALTER TABLE `consulta`
  MODIFY `cod_consulta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `dentista`
--
ALTER TABLE `dentista`
  MODIFY `cod_dentista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
